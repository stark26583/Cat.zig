...
pub fn package(
    ...
    if (args.options.with_imgui) {
        zgui_c_cpp.addCSourceFiles(.{
            .files = &.{
                "src/deps/zgui/libs/imgui/imgui.cpp",
                "src/deps/zgui/libs/imgui/imgui_widgets.cpp",
                "src/deps/zgui/libs/imgui/imgui_tables.cpp",
                "src/deps/zgui/libs/imgui/imgui_draw.cpp",
                "src/deps/zgui/libs/imgui/imgui_demo.cpp",
            },
            .flags = cflags,
        });
    }
    ...
    if (args.options.with_implot) {
        ...
        zgui_c_cpp.addCSourceFiles(.{
            .files = &.{
                "src/deps/zgui/libs/imgui/implot_demo.cpp",
                "src/deps/zgui/libs/imgui/implot.cpp",
                "src/deps/zgui/libs/imgui/implot_items.cpp",
            },
            .flags = cflags,
        });
    } else {
